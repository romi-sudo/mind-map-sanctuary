    ...
    <section className="photo-section min-h-[80vh] flex items-center">
      ...
      <div className="container mx-auto px-6 py-28 md:py-36 relative z-10">
        <div ref={ref} className={`reveal ${isVisible ? "visible" : ""}`}>
          <p className="font-body text-sm tracking-[0.25em] uppercase text-center mb-4 text-white/80">שלושה צעדים</p>
          <h2 className="font-display text-[2.2rem] md:text-[3.5rem] font-bold text-white text-center mb-4">
            איך זה עובד?
          </h2>
          <div className="w-16 h-px mx-auto mb-16 bg-white/40" />
        </div>
