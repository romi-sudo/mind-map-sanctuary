    ...
    <section ref={sectionRef} className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="container mx-auto px-6 text-center relative z-10 max-w-4xl pt-20">
        <motion.h1
          ...
          className="font-hebrew text-5xl md:text-7xl lg:text-8xl font-bold text-white leading-[1.1] mb-6 drop-shadow-lg"
        >
          מפת הנפש שלך —{" "}
        ...
        <motion.div
          ...
          className="w-20 h-[1.5px] bg-white/50 mx-auto mb-8"
        />
        ...
        <motion.p
          ...
          className="font-body text-lg md:text-xl text-white/85 leading-relaxed max-w-2xl mx-auto mb-12 drop-shadow-md"
        >
