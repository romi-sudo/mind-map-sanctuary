  ...
  return (
    <section className="py-24 md:py-28 bg-background">
      <div className="container mx-auto px-6">
        {/* Nature image accent */}
        <div className="rounded-3xl overflow-hidden mb-16 max-w-3xl mx-auto shadow-warm">
          <img
            src={tropicalImg}
            alt="Tropical plumeria flowers on sand"
          ...
          {stats.map((stat, i) => (
            <div key={stat.label} className="flex items-center">
              <div className="text-center px-14 py-6 md:py-0">
                ...
                <span className="font-body text-muted-foreground text-base font-medium">
                  {stat.label}
                </span>
              </div>
              {i < stats.length - 1 && (
