...
const Terms = () => {
  ...
  const sections = t("legal.terms.sections", { returnObjects: true }) as { t: string; b: string }[];
    ...
    <div dir={dir} className="min-h-screen bg-leaves">
      ...
      <main className="pt-28 pb-20 px-6">
        <article className="spa-card max-w-3xl mx-auto">
          <h1 className="font-display text-3xl mb-8 text-foreground">{t("legal.terms.title")}</h1>
